...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference("Dish.count") do
      post dishes_url, params: { dish: { category: @dish.category, dish_id: @dish.dish_id, name: @dish.name } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { category: @dish.category, dish_id: @dish.dish_id, name: @dish.name } }
