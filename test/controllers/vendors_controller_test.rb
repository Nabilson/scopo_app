...
class VendorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vendor" do
    assert_difference("Vendor.count") do
      post vendors_url, params: { vendor: { address: @vendor.address, email: @vendor.email, name: @vendor.name, phone: @vendor.phone } }
    end
  ...
  test "should update vendor" do
    patch vendor_url(@vendor), params: { vendor: { address: @vendor.address, email: @vendor.email, name: @vendor.name, phone: @vendor.phone } }
